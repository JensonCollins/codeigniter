...
class Admin_Controller extends MY_Controller
{
    ...
    public function tbl_parts($order_by){
        $this->global_model->_table_name = 'tbl_parts';
        $this->global_model->_order_by = $order_by;
    ...
    public function tbl_orders($order_by){
        $this->global_model->_table_name = 'tbl_orders';
        $this->global_model->_order_by = $order_by;
        $this->global_model->_primary_key = 'order_id';
    }
    ...
    public function tbl_order_parts($order_by){
        $this->global_model->_table_name = 'tbl_order_parts';
        $this->global_model->_order_by = $order_by;
        $this->global_model->_primary_key = 'id';
    }
