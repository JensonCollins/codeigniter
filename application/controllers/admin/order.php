...
class Order extends Admin_Controller
{
    ...
    public function save_order()
    {
        ...
        $data_order = $this->global_model->array_from_post(array('disposal_no','grand_total', 'total_tax', 'discount','note', 'payment_ref', 'discount_amount'));
        ...
        {
            $data_order['customer_name'] = 'Walk-in Client';
        }else
        {
            ...
            $data_order['customer_fc']= $customer_info->fc_no;
    ...
    public function order_invoice($id=null)
    {
        ...
        //order information
        $this->tbl_order('order_id');
        $data['order']= $this->global_model->get_by(array('order_id'=>$data['invoice_info']->order_id), true);
