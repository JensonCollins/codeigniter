...
class Purchase extends Admin_Controller
{
    ...
    public function new_purchase($flag = null)
    {
        ...
        //add category to form ...use get_subcategory_by_category to add subcategory
    ...
    public function add_new_product_to_cart()
    {
        ...
        $product_calibre = $this->input->post('calibre');
    ...
    public function save_purchase()
    {
        ...
        foreach($cart as $item)
        {
            ...
            $data['product_calibre'] = $item['calibre'];
            $data['product_serial'] = $item['serial'];
            $data['subcategory_id'] = $item['subcategory'];
            $data['qty'] = $item['qty'];
