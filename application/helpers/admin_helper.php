...
function btn_orders($uri) {
    return anchor($uri, '<span class="glyphicon glyphicon-search"></span>', array('class' => "btn bg-olive btn-xs",'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'View Orders'));
}
...
function btn_print_job() {
    return anchor('','<span class="glyphicon glyphicon-print"></i></span>', array('class' => "btn btn-customs btn-xs", 'title'=>'View Job','data-toggle'=>'tooltip', 'data-placement'=>'top'));
}

function btn_print_all_job() {
    return anchor('','<span class="glyphicon glyphicon-print"></i></span>', array('class' => "btn btn-primary btn-xs", 'title'=>'View All Jobs','data-toggle'=>'tooltip', 'data-placement'=>'top'));
}
