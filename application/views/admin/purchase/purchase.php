                                        ...
                                        <div class="tab-pane" id="add-product">
                                            <form method="post" id="newform" action="<?php echo base_url(); ?>admin/purchase/add_new_product_to_cart">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="subcategory" class="form-control col-sm-5" id="subcategory">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input class="form-control" placeholder="Product Serial" type="text" name="serial">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Product Calibre</label>
                                                    <input class="form-control" placeholder="Product Calibre" type="text" name="calibre">
                                                </div>
                                                <div class="form-group">
