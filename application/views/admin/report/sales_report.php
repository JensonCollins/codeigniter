                                ...
                                <?php if (!empty($invoice_details)): foreach ($invoice_details as $invoice_no => $order_details) : ?>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr style="background-color: #ECECEC">
                                            ...
                                            <th class="desc">Invoice #</th>
                                            <th class="desc">Invoice Date</th>
                                            <th class="desc">FC No</th>
                                        ...
                                        <?php $k =1?>
                                            <?php if (!empty($order_details)): foreach ($order_details as $v_order) : ?>
                                                <tr>
                                                    ...
                                                    <td class="desc"><?php echo $invoice_no  ?></td>
                                                    <td class="desc"><?php echo date('Y-m-d', strtotime($order[$key]->invoice_date)) ?></td>
                                                    <td class="desc"><?php echo $v_order->customer_fc ?></td>
                                                    <td class="desc"><?php echo $v_order->customer_name ?></td>
                                                    <td class="desc"><?php echo $v_order->product_type ?></td>
