        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<form role="form" enctype="multipart/form-data" id="addOrdersForm"
                      action="<?php echo base_url(); ?>admin/orders/save_orders/<?php if (!empty($orders->id)) {
                          echo $orders->id;
                      } ?>"
                      method="post">
				<div class="col-md-12 col-sm-12">
				    ...
				    <div class = "form-group col-md-6 col-sm-6">
						<label for="Customer">Add Customer</label><a href="javascript:;" onclick="clearSelection('Customer');" style="font-weight:normal;margin-left:5px;">Clear All</a>
						<select class="form-control select2" id="Customer" name="Customer" style="width: 100%;">
						<option value="">Select Customer</option>
						<?php
						foreach ($customers as $pc_qt_value) 
						{   //print_r($pc_qt_value);
						if($orders->Customer == $pc_qt_value->customer_id)
						{
				...
				<div class="form-group col-md-3 col-sm-3">
				<button class="btn btn-success btn-add btn-xs" type="button" id="add_parts"><span class="glyphicon glyphicon-plus" style="font-family: Helvetica,Arial,sans-serif;">&nbsp;Add Parts</span></button>
				</div>
				</div>
