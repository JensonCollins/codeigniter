...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            <h1>Storage Order Invoice <?php echo $invoice_info->storage_invoice_no ?></h1>
            <div class="date">Date of Invoice: <?php echo date('Y-m-d', strtotime($invoice_info->storage_invoice_date )) ?></div>
            <div class="date">Sales Person: <?php echo $order_info->store_by ?></div>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <th class="qty text-right">Size</th>
                        ...
                        <tr>
                            ...
                            <td class="qty"><?php echo $v_order['product_size'] ?></td>
...
<!--                         <?php if($order_info->discount):?>
                        ...
                        <tr>
                            ...
                            <td><?php echo '$ '.number_format($order_info->total_cost,2) ?></td>
                        </tr>
                        </tfoot>
                    </table>
