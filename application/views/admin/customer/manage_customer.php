                ...
                <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <tr>
                                ...
                                <th class="active">Customer Short Name</th>
                                <th class="active">Customer Long Name</th>
                            ...
                            <?php if (!empty($customer)): foreach ($customer as $v_customer) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td"><?php echo $v_customer->ShortName ?></td>
                                    <td class="vertical-td"><?php echo $v_customer->LongName ?></td>
                                    <td class="vertical-td"><?php echo $v_customer->Contact ?></td>
                                    ...
                                    <td class="vertical-td">
                                        ...
                                        <?php echo btn_orders('admin/orders/manage_order/' . $v_customer->customer_id); ?>
                                    </td>
