			...
			<div class="row ">
				<div class="col-md-12">
					<table width="1100" cellpadding="2" border="1">
						...
						<tbody>
						<tr>
							<td colspan="5" width="50%" valign="top" align="right"><b></b></td>
							<td></td>
							<td colspan="7" align="left"><b>Bedford Engineering - Job Card</b></td>
						</tr>
						<tr>
							<td rowspan="5" colspan="5" valign="top" align="left">
								Notes:
								<h4><?php if (!empty($part_info->Notes)) {
										echo $part_info->Notes;
									} ?></h4>
							</td>
							<td rowspan="23" valign="top" align="left">__</td>
							<td valign="top" align="left">Job No:
								<h4><?php if (!empty($order_parts->id)) {
										echo $order_parts->id;
									} else {
										echo "N/A";
									} ?></h4>
							</td>
							<td colspan="6" valign="top" align="left">Description:<br>
								<h4><?php if (!empty($part_info->Description)) {
						...
						<tr>
							<td valign="top" align="left">Customer:<br>
								<h4><?php if (!empty($orders->customer_id)) {
							...
							<td valign="top" align="left">Order No:<br>
								<h4> <?php if (!empty($orders->OrderNo)) {
										echo $orders->OrderNo;
									} else {
										echo "N/A";
									} ?></h4>
							...
							<td colspan="3" valign="top" align="left">Drg No (Part #):<br>
								<h4><?php if (!empty($part_info->PartNo)) {
										echo $part_info->PartNo;
									} else {
										echo "N/A";
									} ?></h4>
							</td>
							<td colspan="2" valign="top" align="left">Quantity:<br>
								<h4><?php if (!empty($order_parts->quantity)) {
						...
						<tr>
							...
							<td valign="top" align="left">Delivery Due:<br>
								<h4><?php if (!empty($orders->DueDeliveryDate)) {
							...
							<td colspan="2" valign="top" align="left">Issue:<br>
								<h4><?php if (!empty($part_info->Issue)) {
						...
						<tr>
							<td rowspan="2" colspan="5" valign="top" align="left">Mat Stored:</td>
						...
						<tr>
							<td colspan="5" valign="top" align="left">Inspection:</td>
						...
						<tr>
							...
							<td valign="top" align="left">INSPECTOR</td>
							<td valign="top" align="left">Feature</td>
							<td valign="top" align="left">PASS/FAIL</td>
							<td valign="top" align="left">DATE</td>
							<td colspan="2" valign="top" align="left"><h4><?php if (!empty($part_info->OperationF8)) {
										echo $part_info->OperationF8;
									} ?></h4></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
						...
						<tr>
							...
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
							<td colspan="2" valign="top" align="left"><h4><?php if (!empty($part_info->OperationF9)) {
										echo $part_info->OperationF9;
									} ?></h4></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
						...
						<tr>
							...
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
							<td colspan="2" valign="top" align="left"><h4><?php if (!empty($part_info->OperationF10)) {
										echo $part_info->OperationF10;
									} ?></h4></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
							<td valign="top" align="left"></td>
						...
						<tr>
							...
							<td rowspan="4" colspan="5" valign="top" align="left"><b>Office Use Only</b><br>
								Completed:<br>
								Date:<br>
								Delivery Note No:
							</td>
