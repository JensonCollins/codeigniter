    ...
    <div class="box-body">
        ...
        <div id="printableArea">
            ...
            <div class="row ">
				...
				Notes:<br>
				<h3><?php if(!empty($part_info->Notes)) { echo $part_info->Notes; } ?></h3>
				</td>
				...
				<h3><?php if(!empty($orders->customer_id)) { echo $CI->get_customer_short_name($orders->customer_id);} else { echo "N/A"; } ?></h3>
				</td>
				...
				<h3><?php if(!empty($part_info->Issue)) { echo $part_info->Issue;} ?></h3></td>
