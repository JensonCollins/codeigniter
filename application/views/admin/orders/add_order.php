            ...
            <div class="box box-primary">
                ...
                <div class="panel-body">
                    <form role="form" enctype="multipart/form-data" id="addOrdersForm"
                          action="<?php echo base_url(); ?>admin/orders/save_orders/<?php
                          if (!empty($orders->order_id)) {
...
if (!empty($orders->order_id)) {
    ...
    if (!empty($order_parts)): foreach ($order_parts as $part) :
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class = "form-group col-md-6 col-sm-6">
                                                    ...
                                                    <select class="form-control select2" id="sel_parts_<?php echo $part->part_id; ?>" name="sel_parts[]" style="width: 100%;">
                                                        ...
                                                        <?php
                                                        foreach ($parts as $pc_qt_value) {   //print_r($pc_qt_value);
                                                ...
                                                if ($part->Status == 'On Hold') {
                                                    echo 'selected';
                                                } else {
                                                    echo '';
                                                }
                                                ?>>On Hold</option>
                                                                    <option value="Invoiced" <?php
                                    if ($part->Status == 'Invoiced') {
                                        echo 'selected';
                                    } else {
                                        echo '';
                                    }
            ...
            <?php //echo display_ckeditor($editor['ckeditor']);   ?>
                                             ...
                                             <label for="mat_supplier">Mat Supplier<!-- <span class="required">*</span> --></label>   
                                                    <input type="text" name="mat_supplier[]" placeholder="Enter Mat Supplier" value="<?php
            if (!empty($part->mat_supplier)) {
                echo $part->mat_supplier;
            }
            ?>"
                                                           class="form-control">
                                                </div>
                                             ...
                                             <label for="mat_cost">Mat Cost <!-- <span class="required">*</span> --></label>   
                                                    <input type="text" name="mat_cost[]" placeholder="Enter Mat Cost" value="<?php
            if (!empty($part->mat_cost)) {
                echo $part->mat_cost;
            }
            ?>"
                                                           class="form-control">
            ...
            ?>"
                                                    ...
                                                    ?>
                        <div id="deceased">
                        <div class="add-parts-clone2 hide">
                                    <div class="col-md-12 col-sm-12">
                                        <div class = "form-group col-md-3 col-sm-3">
                                            ...
                                            <select class="form-control select2 parts" id="sel_parts" name="sel_parts1" style="width: 100%;">
                                                <option value="">Select Parts</option>
    <?php
    foreach ($parts as $pc_qt_value) {   //print_r($pc_qt_value);
    ...
    ?>
                                        ...
                                        <div class = "form-group col-md-2 col-sm-2">
                                            <label for="part_qty">Quantitiy # <span class="required">*</span></label>   
                                            <input type="text" name="part_qty1" placeholder="Enter Quantity" value=""
                                                   class="form-control qty">
                                        </div>

                                        <div class = "form-group col-md-2 col-sm-2">
                                     <label for="mat_supplier">Mat Supplier<!-- <span class="required">*</span> --></label>   
                                            <input type="text" name="mat_supplier1" placeholder="Enter Mat Supplier" value=""
                                                   class="form-control mat_sup">
                                        </div>


                                        <div class = "form-group col-md-2 col-sm-2">
                                     <label for="mat_cost">Mat Cost <!-- <span class="required">*</span> --></label>   
                                            <input type="text" name="mat_cost1" placeholder="Enter Mat Cost" value=""
                                                   class="form-control mat_cost">
                                        </div>

                                        <div class = "form-group col-md-2 col-sm-2">
                                     <label for="order_price">Order Price<!-- <span class="required">*</span> --></label>   
                                            <input type="text" name="order_price1" placeholder="Enter Order Price" value=""
...
<!--                                    <div class="add-parts-clone2 hide">
                                            <div class="col-md-12 col-sm-12">
                                                <div class = "form-group col-md-6 col-sm-6">
                                                    <label for="sel_parts">Parts</label><a href="javascript:;" onclick="clearSelection('sel_parts_<?php echo $part->part_id; ?>');" style="font-weight:normal;margin-left:5px;">Clear All</a>
                                                    <select class="form-control select2" id="sel_parts" name="sel_parts2[]" style="width: 100%;">
                                                        <option value="">Select Parts</option>
                                                        <?php
                                                        foreach ($parts as $pc_qt_value) {   //print_r($pc_qt_value);
                                                            if ($part->part_id == $pc_qt_value->id) {
                                                ...
                                                <div class = "form-group col-md-3 col-sm-3">
                                                    <label for="part_qty">Quantitiy # <span class="required">*</span></label>   
                                                    <input type="text" name="part_qty2[]" placeholder="Enter Quantity" class="form-control">
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class = "form-group col-md-3 col-sm-3">
                                             <label for="mat_supplier">Mat Supplier <span class="required">*</span> </label>   
                                                    <input type="text" name="mat_supplier2[]" placeholder="Enter Mat Supplier" class="form-control">
                                                </div>


                                                <div class = "form-group col-md-3 col-sm-3">
                                             <label for="mat_cost">Mat Cost  <span class="required">*</span> </label>   
                                                    <input type="text" name="mat_cost2[]" placeholder="Enter Mat Cost" class="form-control">
                                                </div>

                                                <div class = "form-group col-md-3 col-sm-3">
                                             <label for="order_price">Order Price <span class="required">*</span> </label>   
                                                    <input type="text" name="order_price2[]" placeholder="Enter Order Price" class="form-control">
                                                </div>
                                ...
                                <div class="col-md-12 col-sm-12" id="addblock">
                                    <div class="form-group col-md-3 col-sm-3">
                                        <button class="btn btn-success btn-add btn-xs" type="button" id="add_parts_edit"><span class="glyphicon glyphicon-plus" style="font-family: Helvetica,Arial,sans-serif;">&nbsp;Add More Parts</span></button>
                                    </div>
                                </div>
                                            <?php } else { ?>
