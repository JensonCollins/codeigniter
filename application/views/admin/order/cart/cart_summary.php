...
<div class="box-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form method="post" action="<?php echo base_url(); ?>admin/order/new_order">
                <div class="input-group">
                    <input type="text" class="form-control" value="<?php echo $this->session->userdata('customer_name'); ?>" placeholder="Walk-In Client">
                    <span class="input-group-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 order-panel"  id="shipping">
                            <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                <li class="active"><a href="#disposal" data-toggle="tab">Disposal No</a></li>
                                <li><a href="#note" data-toggle="tab">Order Note</a>
                                </li>
                        ...
                        <div id="my-tab-content" class="tab-content">
                            ...
                            <!-- ***************  Cart Tab Start ****************** -->
                            <div class="tab-pane active" id="disposal">
                                <div class="form-group">
                                    <label>Disposal No.</label>
                                    <input type="text" name="disposal_no" class="form-control">
                                </div>
                            </div>
