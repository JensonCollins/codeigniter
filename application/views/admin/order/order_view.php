                ...
                <main>
                    <div id="details" class="clearfix">
                        <div id="client" style="margin-right: 100px">
                            ...
                            <div class="email">FC No: <?php echo $order_info->customer_fc ?><br></div>
                            <div class="address"><?php echo $order_info->customer_address ?><br></div>
                            <div class="address">Mobile: <?php echo $order_info->customer_phone ?></div>
                        </div>


                        <div id="invoice">
                            <h1>ORDER <?php echo $order_info->order_no ?></h1>
                            <h4>DISPOSAL NO <?php echo $order_info->disposal_no ?></h4>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <th class="desc">TYPE</th><!-- This will refer to the Product subcategory name-->
                        ...
                        <tr>
                            ...
                            <!-- Replace selling price below with Product Subcategory Name -->
                            <td class="unit"><?php echo number_format($v_order->selling_price, 2); ?></td>
                            <!-- Replace Sub Total below with Product Serial -->
