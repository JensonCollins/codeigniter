					...
					<table class="table table-bordered table-striped" id="dataTables-example">
						...
						<?php if (count($all_employee_info)): foreach ($all_employee_info as $v_employee) : ?>
							...
							<tr>
								...
								<td>
									<?php echo btn_edit('admin/employee/add_employee/' . $this->encrypt->encrypt($v_employee->user_id)); ?>
									<?php echo btn_delete('admin/employee/delete_user/' . $this->encrypt->encrypt($v_employee->user_id)); ?>
								</td>
